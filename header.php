...
<body <?php body_class(); ?>>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="<?php echo esc_url(site_url()); ?>"><span
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="ml-auto navbar-nav">
          <li class="nav-item <?php if(is_page( 'home' )) echo 'active'; ?>"><a
              href="<?php echo esc_url(site_url()); ?>" class="nav-link">Home</a></li>
          <li class="nav-item <?php if(is_page( 'about' )) echo 'active'; ?>"><a
              href="<?php echo esc_url(site_url('/about')); ?>" class="nav-link">About</a></li>
          <li class="nav-item <?php if(is_page( 'menu' )) echo 'active'; ?>"><a
              href="<?php echo esc_url(site_url('/menu')); ?>" class="nav-link">Menu</a></li>
          ...
          <li class="nav-item <?php if(is_page( 'contact' )) echo 'active'; ?>"><a
              href="<?php echo esc_url(site_url('/contact')); ?>" class="nav-link">Contact Us</a></li>
        </ul>
      </div>
    </div>
  </nav>
